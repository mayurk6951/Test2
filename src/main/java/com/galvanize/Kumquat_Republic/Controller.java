...
objectRepository objectRepository;
    ...
    @GetMapping("product/brand/{color}")
    ...
    @GetMapping("product/brand/{price1}/{price2}")
    ...
    @GetMapping("product/brand/{brand}/{color}")
    ...
    @GetMapping("product/brand/ascprice")
    ...
    @GetMapping("product/brand/descprice")
